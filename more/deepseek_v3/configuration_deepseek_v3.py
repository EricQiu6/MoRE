...
"""DeepSeekV3 model configuration (with depth embedding and parameter tying)."""
...
class DeepseekV3Config(PreTrainedConfig):
    ...
    Args:
        ...
        pretraining_tp (`int`, *optional*, defaults to 1):
            ...
            issue](https://github.com/huggingface/pytorch/issues/76232).
        ...
        use_depth_embedding (`bool`, *optional*, defaults to `False`):
            Whether to add learned depth embeddings (one per layer) before the MLP in each decoder layer.
        grouping_factor (`int`, *optional*, defaults to 1):
            Number of consecutive MoE layers that share expert weights when parameter tying is enabled. Ignored if <= 1.
        tying_strategy (`str`, *optional*, defaults to `"block"`):
            How to group MoE layers for tying: `"block"` (consecutive layers) or `"strided"`. Used only when grouping_factor > 1.
    ...
    def __init__(
        ...
        use_depth_embedding: bool | None = False,
        grouping_factor: int | None = 1,
        tying_strategy: str | None = "block",
        **kwargs,
    ):
        ...
        self.tying_strategy = tying_strategy
