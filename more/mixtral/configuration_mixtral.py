...
class MixtralConfig(PretrainedConfig):
    ...
    def __init__(
        ...
        use_second_aux_loss=False,
        use_grouped_aux_loss=False,
        all_grouped_aux_loss=False,
        **kwargs,
    ):
        ...
        self.use_second_aux_loss = use_second_aux_loss
        self.use_grouped_aux_loss = use_grouped_aux_loss
        self.all_grouped_aux_loss = all_grouped_aux_loss
